  ...
  const fetchActive = useCallback(
    async (showToast = false) => {
      try {
        ...
        setActiveCount((prev) => {
          if (showToast && data.count > prev && data.alerts?.length) {
        ...
        <Tabs
          ...
          items={[
              ...
              children: (
                <>
                  ...
                  <Table
                    ...
                    pagination={false}
                    locale={{
                      emptyText: 'Aucune règle. Cliquez sur "Nouvelle règle".',
                    }}
                  />
                </>
              ),
            },
            {
              key: 'history',
              label: (
                <Badge count={activeCount} size="small" offset={[8, -2]}>
                  Historique
                </Badge>
              ),
              children: (
